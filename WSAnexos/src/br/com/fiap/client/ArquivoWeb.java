...
public interface ArquivoWeb {
    ...
    @Action(input = "http://exemplos.ws.fiap.com/ArquivoWeb/downloadRequest", output = "http://exemplos.ws.fiap.com/ArquivoWeb/downloadResponse")
    ...
    @Action(input = "http://exemplos.ws.fiap.com/ArquivoWeb/uploadRequest", output = "http://exemplos.ws.fiap.com/ArquivoWeb/uploadResponse")
    public void upload(
        @WebParam(name = "arg0", targetNamespace = "")
        String arg0,
