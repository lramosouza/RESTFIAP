...
public interface AlunoWeb {
    ...
    @Action(input = "http://ws.exemplos.fiap.com/AlunoWeb/listarRequest", output = "http://ws.exemplos.fiap.com/AlunoWeb/listarResponse")
    ...
    @WebMethod
    @WebResult(targetNamespace = "")
    @RequestWrapper(localName = "isAutenticado", targetNamespace = "http://ws.exemplos.fiap.com/", className = "br.com.fiap.client.IsAutenticado")
    @ResponseWrapper(localName = "isAutenticadoResponse", targetNamespace = "http://ws.exemplos.fiap.com/", className = "br.com.fiap.client.IsAutenticadoResponse")
    @Action(input = "http://ws.exemplos.fiap.com/AlunoWeb/isAutenticadoRequest", output = "http://ws.exemplos.fiap.com/AlunoWeb/isAutenticadoResponse")
